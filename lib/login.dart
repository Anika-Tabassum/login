...
class _LoginWithRestfulApiState extends State<LoginWithRestfulApi> {
  static var uri = "http://borlens.com/user_accounts";
  ...
  Future<dynamic> _loginUser(String email, String password,String password_confirmation) async {
    try {
      ...
      Response response = await dio.post('uri',
          data: {"email": email, "password": password, "password_confirmation": password_confirmation}, options: options);
